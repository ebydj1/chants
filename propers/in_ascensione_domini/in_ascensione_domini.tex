...
\includescore[a]{in--viri_galilaei--solesmes.gabc}
...
\setfirstannotation{\small \textbf{4.}}
\includescore[a]{al--ascendit_deus--solesmes.gabc}
\textbf{(Ps. 46. 6)} God is ascended with jubilee, and the Lord with the sound of a trumpet.

\vskip10pt

\setfirstannotation{\small \textbf{8.}}
\includescore[a]{al--dominus_in_sina--solesmes.gabc}
...
\includescore[a]{of--ascendit_deus--solesmes.gabc}
...
\setsecondannotation{\small \textbf{1.}}
\includescore[a]{co--psallite_domino--solesmes.gabc}
